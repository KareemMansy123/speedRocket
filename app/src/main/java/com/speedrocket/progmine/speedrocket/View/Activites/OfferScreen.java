...
import com.speedrocket.progmine.speedrocket.Control.OfferAdapter;
...
public class OfferScreen extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getOffers();
        mAdapter = new OfferAdapter(offerList1, OfferScreen.this);
    ...
    public void shoppingCart(View view ){
        ...
        Intent intent = new Intent (OfferScreen.this , shoppingCaretActivity.class);
            ...
            public void run()
            {
               ...
               /* Toast.makeText(getApplicationContext(),"Connection Faild",
                        ...
                        if (t instanceof IOException){
                            final Dialog noInternet = AppConfig.InternetFaild(OfferScreen.this);
...
// Retrofit
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            if (check){
                mAdapter = new OfferAdapter(offerList1, this );
                mAdapter.notifyDataSetChanged();
                recyclerView.setAdapter(mAdapter);
                check = false ;
            }else{
    ...
    public void active (View v){
        ...
        mAdapter = new OfferAdapter(offerListfilter , this ) ;
        mAdapter.notifyDataSetChanged();
        recyclerView.setAdapter(mAdapter);
        for (int i = 0 ; i < offerList1.size() ; i++){
            if(offerList1.get(i).isNow()){
                offerListfilter.add(offerList1.get(i));
                mAdapter.notifyDataSetChanged();
            }
