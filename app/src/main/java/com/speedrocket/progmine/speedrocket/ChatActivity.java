...
import com.speedrocket.progmine.speedrocket.Control.GetTimeAgo;
import com.speedrocket.progmine.speedrocket.Control.MessageAdapter2;
import com.speedrocket.progmine.speedrocket.Control.Messages;
...
public class ChatActivity extends AppCompatActivity {
  ...
  //  String mCurrentUserId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentUserId = prefs.getInt("id", 0);
        ...
        mUserLastSeen = (TextView) actionBarView.findViewById(R.id.time_show);
...
//        mImageStorage = FirebaseStorage.getInstance().getReference();
       ...
       // mCurrentUserId = mAuth.getCurrentUser().getUid();
        ...
        mMessageAdapter = new MessageAdapter2(messagesList);
        ...
        mRootReference.child("users").child(mChatUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
               ...
               // String imageValue = dataSnapshot.child("thumb_image").getValue().toString();
                ...
                Picasso.with(ChatActivity.this).load(R.drawable.username).placeholder(R.drawable.username).into(mUserImage);
        ...
        mRootReference.child("chats").child(mCurrentUserId.toString()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(message)){
                    ...
                    DatabaseReference user_message_push = mRootReference.child("messages")
                            .child(mCurrentUserId.toString()).child(mChatUser).push();
    ...
    private void loadMessages() {
        ...
        DatabaseReference messageRef = mRootReference.child("messages").child(mCurrentUserId.toString()).child(mChatUser);
